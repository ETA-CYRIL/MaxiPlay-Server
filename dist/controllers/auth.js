...
exports.logOut = exports.sendProfile = exports.updateProfile = exports.signIn = exports.updatePassword = exports.grantValid = exports.generateForgetPasswordLink = exports.sendReVerificationToken = exports.verifyEmail = exports.create = void 0;
...
const updatePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, mail_1.sendPassResetSeccuessEmail)(user.name, user.email);
...
const updateProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        throw new Error("something went wring, user not found!");
    ...
    if (avatar) {
        if ((_b = user.avatar) === null || _b === void 0 ? void 0 : _b.publicId)
            yield cloud_1.default.uploader.destroy((_c = user.avatar) === null || _c === void 0 ? void 0 : _c.publicId);

...
const updateFollower = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(0, mongoose_1.isValidObjectId)(profile))
        return res.status(422).json({ error: "profile profile Id" });
    const alreadyFollower = yield user_1.default.findOne({
        _id: profileId,
...
const getAutoGeneratedPlaylist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const title = "Mix 20";
    if (result) {
        yield playlist_1.default.updateOne({ owner: req.user.id, title }, { $set: { title, items: result.item, visibility: "auto" } }, { upsert: true });
    }
    const category = yield (0, helper_1.getUsersPreviousHistory)(req);
    let matchOptions = {
        $match: { _id: { $exists: true } },
            ...
            $group: {
                ...
                audios: {
                    $push: {
                        ...
                        owner: { name: "$userInfo.name", id: "userInfo.id" },
                    },
                },
            },
        },
...
const getIsFollowing = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { profileId } = req.params;
    if (!(0, mongoose_1.isValidObjectId)(profileId))
        return res.status(422).json({ error: "Invalid profileId id!" });

...
exports.getLastestUploads = exports.UpdateAudio = exports.createAudio = void 0;
...
const createAudio = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!audioFile)
        return res.status(422).json({ error: "Audio Files is missing" });
...
const UpdateAudio = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (poster) {
        if ((_b = audio.poster) === null || _b === void 0 ? void 0 : _b.publicId) {
    ...
    res.status(201).json({
        audio: {
            ...
            about,
            file: audio.file.url,
            poster: (_c = audio.poster) === null || _c === void 0 ? void 0 : _c.url,
        },
    });
});
exports.UpdateAudio = UpdateAudio;
const getLastestUploads = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getLastestUploads = getLastestUploads;

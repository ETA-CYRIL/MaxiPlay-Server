...
exports.isAuth = exports.isVerified = exports.mustAuth = exports.isValidPasswordResetToken = void 0;
...
const isValidPasswordResetToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!matched)
        return res
            .status(403)
            .json({ error: "Unauthorized access,  token doesn't match " });
    next();
});
...
const mustAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        return res.status(403).json({ error: "Unauthorized request user" });
    (req.user = {
        id: user._id,
        name: user.name,
        email: user.email,
